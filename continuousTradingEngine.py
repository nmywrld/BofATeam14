...
def csv_to_dict(filename):
    ...
    return data
order_data = csv_to_ArrayDict('./hong_testing/filtered_orders.csv')
...
for order in order_data:
    ...
    if order['Side'] == "Sell":
        ...
        currObj = sellOrderNode(time_string_to_int(order['Time']), order['OrderID'], order['Instrument'], int(order['Quantity']), order['Client'], order['Price'], order['Side'], order['PositionCheck'], int(order['Rating']))
        
        #checking balance
        if client_dict[currObj.client_id][currObj.instrument] < currObj.quantity and currObj.client_position_check == 'N':
            #order is invalid
            #OUTPUT!! TODO
            continue
        ...
        #this is a buy
        currObj = buyOrderNode(time_string_to_int(order['Time']), order['OrderID'], order['Instrument'], int(order['Quantity']), order['Client'], order['Price'], order['Side'], order['PositionCheck'], int(order['Rating']))
